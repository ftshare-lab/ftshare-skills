...
| 外部接口 | GET /gateway/api/v1/market/data/economic/china-industrial-added-value |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/gateway/api/v1/market/data/economic/china-industrial-added-value
```
