...
|------|------|
| 接口名称 | ETF 分页列表 |
| 外部接口 | `GET /gateway/api/v1/market/data/daec/etfs` |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/gateway/api/v1/market/data/daec/etfs?order_by=change_rate%20desc&page_size=20&page=1
```
