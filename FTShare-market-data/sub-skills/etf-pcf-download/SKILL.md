...
|------|------|
| 接口名称 | 下载指定 PCF 文件 |
| 外部接口 | `GET /gateway/api/v1/market/data/etf-pcf/etf-pcfs/{filename}` |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/gateway/api/v1/market/data/etf-pcf/etf-pcfs/pcf_159003_20260309.xml
```
