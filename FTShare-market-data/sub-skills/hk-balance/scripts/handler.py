...
ENDPOINTS = {
    "gene": "/gateway/api/v1/market/data/hk/hk-balance-gene",
    "bank": "/gateway/api/v1/market/data/hk/hk-balance-bank",
    "insur": "/gateway/api/v1/market/data/hk/hk-balance-insur",
}
