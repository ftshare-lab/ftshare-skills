...
|------|------|
| 接口名称 | 分页查询指数描述列表 |
| 外部接口 | `/gateway/api/v1/market/data/index/index_description` |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/gateway/api/v1/market/data/index/index_description?page=1&page_size=20
```
