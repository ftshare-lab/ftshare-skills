...
|------|------|
| 接口名称 | 语义搜索新闻 |
| 外部接口 | `GET /gateway/api/v1/market/data/semantic-search-news` |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/gateway/api/v1/market/data/semantic-search-news?query=人工智能&limit=10&year=2026&start_time=2026-03-01T00:00:00%2B08:00&end_time=2026-03-15T23:59:59%2B08:00
```
